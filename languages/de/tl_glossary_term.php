...
$GLOBALS['TL_LANG']['tl_glossary_term']['published']    = array('Frage veröffentlichen', 'Den Term auf der Webseite anzeigen.');
...
$GLOBALS['TL_LANG']['tl_glossary_term']['toggle'] = array('Begriff veröffentlichen/unveröffentlichen', 'Begriff ID %s veröffentlichen/unveröffentlichen');
